...
public class LearningChatbot {
     ...
     */
    private static final ChatWord ENDWORD = new ChatWord("\n");
    ...
    static class ChatbotBrain {
         ...
         */
        static final int NOMINAL_LENGTH = 10;
        /**
         ...
         */
        static final int BREADTH_ASSURANCE_CHANCE = 50;
         ...
         * abbreviations.
         */
        void digestSentence(String sentence) {
         ...
         */
        void incrementWord(ChatWord word) {
            Double curValue;
            Double nextValue;
         ...
         * list.
         */
        Set<ChatWord> topicWords(int maxTopics) {
         ...
         */
        double buildSentence(ChatSentence sentence,
         ...
         */
        void addPunctuation(ChatSentence sentence) {
            ChatWord word = sentence.getLastWord();
    ...
    static class ChatSentence implements Cloneable {
         ...
         */
        ChatSentence addWord(ChatWord word) {
            if (word == null) {
         ...
         */
        ChatSentence addCharacter(Character punc) {
            if (punc == null) {
         ...
         */
        ChatSentence replaceSentence(ChatSentence src) {
            words.clear();
            contains.clear();
            appendSentence(src);
            return this;
        ...
        ChatSentence appendSentence(ChatSentence src) {
    ...
    static class ChatWord {
         ...
         */
        NavigableMap<Integer, Collection<ChatWord>> getDescendents() {
            return firstOrder;
        }
         ...
         */
        void addDescendent(ChatWord next) {
            if (next != null) {
                firstOrderCount++;
                int nextCount = 1;
         ...
         * after a word.
         */
        void addPunctuation(Character punc) {
            if (punc != null) {
                punctuationCount++;
                int puncCount = 1;
         ...
         */
        NavigableMap<Integer, Collection<Character>> getPunctuation() {
            return punctuation;
        }
