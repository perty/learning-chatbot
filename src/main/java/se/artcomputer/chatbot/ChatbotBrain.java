...
import static se.artcomputer.chatbot.LearningChatbot.ENDWORD;
...
public class ChatbotBrain {
     ...
     */
    private static final int NOMINAL_LENGTH = 10;
    /**
     ...
     */
    private static final double TOPIC_SPLIT = 0.48;
    /**
     ...
     */
    private static final int SKIP_CHANCE = 30;
    /**
     * % chance as integer to skip a word that would cause a loop
     */
    private static final int LOOP_CHANCE = 5;
    /**
     * % chance that punctuation will happen at all
     */
    private static final int PUNCTUATION_CHANCE = 40;
    /**
     * % chance that a particular punctuation will be skipped
     */
    private static final int PUNCTUATION_SKIP_CHANCE = 50;
    /**
     * % of high frequency words to skip, to avoid "the, of" etc.
     */
    private static final int TOPIC_SKIP = 1;
    /**
     ...
     */
    private static final int BREADTH_ASSURANCE_CHANCE = 50;
     ...
     */
    private void incrementWord(ChatWord word) {
        Double curValue;
        Double nextValue;
     ...
     */
    private void decayWord(ChatWord word) {
        Double curValue;
        Double nextValue;
        Collection<ChatWord> freqMap;
        if (wordFrequencyLookup.containsKey(word)) {
     ...
     * list.
     */
    private Set<ChatWord> topicWords(int maxTopics) {
     ...
     */
    private double buildSentence(ChatSentence sentence,
     ...
     */
    private void addPunctuation(ChatSentence sentence) {
        ChatWord word = sentence.getLastWord();
